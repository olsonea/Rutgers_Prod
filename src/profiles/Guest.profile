...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <fieldPermissions>
        ...
        <field>BMCServiceDesk__Incident__c.Affected_Application__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>BMCServiceDesk__Incident__c.Affected_Hardware__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>BMCServiceDesk__Incident__c.Alternate_Contact_Name__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>BMCServiceDesk__Incident__c.Alternate_Contact_Number__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>BMCServiceDesk__Incident__c.Client_Phone__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
    ...
    <fieldPermissions>
        <editable>true</editable>
        <field>BMCServiceDesk__Incident__c.External_Ticket_Ref__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <layoutAssignments>
